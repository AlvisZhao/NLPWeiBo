...
<%
	...
	String string = request.getParameter("purchasePalnCode");
	User user = (User) httpSession.getAttribute("userInfo");
	request.setAttribute("userRole", user.getRole());
	request.setAttribute("userName", user.getCname());
	request.setAttribute("planCode", string);
	System.out.println("用户信息：" + user.getRole() + "中文名：" + user.getCname() + "  采购计划编码：" + string);
%>
<!DOCTYPE html>
<html>
	...
	<body>
			...
			<div class="采购计划">
				<div class="xuanze">
					<table style="margin-top: 10px;margin-left: 20px;font-weight: bold;font-size: 15px;">
						<tbody id="purchase1">
							<td>采购计划名称</td>
							<td><input type="text" id="caigou_name" class="layui-input" style="margin-right: 50px;margin-left: 10px;width: 150px;height: 25px;" disabled="disabled"></td>
							<td>采购计划编码</td>
					...
					<table style="margin-top: 10px;margin-left: 49px;font-weight: bold;font-size: 15px;">
						<tbody id="modifyPlan">
							<tr>
								<td>修改原因</td>
								<td><input type="text" id="change_reason" class="layui-input" style="margin-right: 95px;margin-left: 10px;width: 150px;height: 25px;" disabled="disabled"></td>
								<td>修改人</td>
		...
		<input id="code" value="${planCode}" hidden="true" />
